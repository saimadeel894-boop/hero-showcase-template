    ...
    <section className="py-14 md:py-28 bg-background">
      <div className="max-w-7xl mx-auto px-5 lg:px-8">
        ...
        <div className="text-center mb-10 md:mb-16">
          <h2 className="font-heading font-black text-2xl md:text-4xl lg:text-5xl text-foreground uppercase tracking-wider">
            Our Categories
          </h2>
        </div>

        {/* Categories preview grid — 2 columns, stacked on mobile */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 mb-14 md:mb-24">
          <a href="#" className="group relative aspect-[4/3] overflow-hidden bg-secondary rounded-lg">
            ...
            <h3 className="absolute bottom-4 left-4 md:bottom-6 md:left-6 font-heading font-black text-xl md:text-3xl text-background uppercase">Boxing</h3>
          </a>
          <a href="#" className="group relative aspect-[4/3] overflow-hidden bg-secondary rounded-lg">
            ...
            <div className="absolute inset-0 bg-foreground/20 group-hover:bg-foreground/30 transition-colors" />
            <h3 className="absolute bottom-4 left-4 md:bottom-6 md:left-6 font-heading font-black text-xl md:text-3xl text-background uppercase">Martial Arts</h3>
          </a>
        </div>

        {/* === Category Detail: Boxing === */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center mb-14 md:mb-24">
          <div className="relative">
            <div className="grid grid-cols-2 gap-3 md:gap-4">
              <img src={glovesImg} alt="Boxing gloves" className="w-full object-contain bg-secondary rounded-lg p-4 md:p-6" />
              <img src={headguardImg} alt="Headguard" className="w-full object-contain bg-secondary rounded-lg p-4 md:p-6" />
            </div>
          </div>
          <div>
            <div className="w-10 h-1 bg-primary mb-4 md:mb-5" />
            <h3 className="font-heading font-black text-xl md:text-3xl lg:text-4xl text-foreground uppercase mb-4 md:mb-6">
              Boxing
            </h3>
            <p className="text-muted-foreground leading-relaxed mb-6 md:mb-8 text-sm">
            ...
            <a
              href="#"
              className="inline-block font-heading font-bold text-sm uppercase tracking-wider bg-primary text-primary-foreground px-6 py-3 md:px-8 md:py-3.5 hover:bg-primary/90 transition-colors"
            >
              Explore More
            </a>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center mb-14 md:mb-24">
          <div className="lg:order-2">
            <div className="grid grid-cols-2 gap-3 md:gap-4">
              <img src={mmaGlovesImg} alt="MMA gloves" className="w-full object-contain bg-secondary rounded-lg p-4 md:p-6" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="relative">
            <div className="aspect-[4/3] rounded-lg overflow-hidden bg-secondary">
              <img src={glovesImg} alt="Our Catalogue" className="w-full h-full object-contain p-6 md:p-8" />
            </div>
          </div>
          <div>
            <div className="w-10 h-1 bg-primary mb-4 md:mb-5" />
