      ...
      <div className="max-w-7xl mx-auto px-5 lg:px-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6">
          {features.map((f) => (
            <div
              key={f.title}
              className="group bg-card border border-border rounded-lg p-4 md:p-8 text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:border-primary/30"
            >
              <div className="w-10 h-10 md:w-14 md:h-14 mx-auto mb-3 md:mb-5 rounded-full bg-primary/10 flex items-center justify-center group-hover:bg-primary transition-colors duration-300">
                <f.icon className="w-4 h-4 md:w-6 md:h-6 text-primary group-hover:text-primary-foreground transition-colors duration-300" />
              </div>
              <h3 className="font-heading font-bold text-[10px] md:text-base text-foreground uppercase tracking-wider mb-2 md:mb-3">
                {f.title}
              </h3>
