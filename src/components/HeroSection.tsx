  ...
  return (
    <>
      <style>{`
        ...
        .hero-glove { position: absolute; top: 18%; left: 28%; width: 85px; z-index: 4; transform: rotate(-8deg); will-change: transform; animation: floatBob 3s ease-in-out infinite; }
